...
class KategoriController extends Controller
{
    ...
    public function index()
    {
        ...
        $kategori = KategoriModel::all(); // ambil data kategori untuk filter lebvel
    ...
    public function list(Request $request)
    {
        ...
        return datatables()->of($kategoris)
            ...
            ->addColumn('aksi', function ($kategoris) {
                $btn = '<button onclick="modalAction(\'' . url('/kategori/' . $kategoris->kategori_id . '/show/show_ajax') . '\')" 
                        class="btn btn-info btn-sm">Detail</button> ';

                $btn .= '<button onclick="modalAction(\'' . url('/kategori/' . $kategoris->kategori_id . '/edit_ajax') . '\')" 
                        class="btn btn-warning btn-sm">Edit</button> ';

                $btn .= '<button onclick="modalAction(\'' . url('/kategori/' . $kategoris->kategori_id . '/delete_ajax') . '\')" 
